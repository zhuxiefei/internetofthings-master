...
public class ValidateCodeUtils {
     ...
     * @return 验证码字符串
     */
    public static String generateTextCode(HttpServletRequest request, int type, int length, String exChars) {
    ...
    public static BufferedImage generateImageCode(String textCode, int width, int height, int interLine,
        ...
        for (int i = 0; i < textCode.length(); i++) {
            ...
            if(textCode.length()>0){
            	firstChar = textCode.charAt(i)+"";
            }else{
            	firstChar = "";
            }
            System.out.println("****"+firstChar+"*****");
            System.out.println("*****"+fx+" "+"*********"+fy);
            g.drawString( firstChar, fx, fy);
            fx += fsize * 0.9;
        }
    ...
    public static BufferedImage generateImageCode(int type, int length, String exChars, int width, int height,
        ...
        String textCode = generateTextCode(null, type, length, exChars);
